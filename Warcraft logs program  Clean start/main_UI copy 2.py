    ...
    def plot_average_movement(self, params):
        try:
            ...
            for unit in units:
                ...
                # Calculate time grid with fixed interval of 0.2 seconds
                time_interval = 0.2  # One point every 0.2 seconds
            ...
            tooltip = ax.annotate("",
                xy=(0, 0), xytext=(0, 20),  # Changed to position above point
                textcoords="offset points",
                bbox=dict(boxstyle="round", fc="w", ec="0.5", alpha=1.0),  # Increased alpha
                visible=False,
                zorder=100  # Ensure tooltip is above everything
            )
