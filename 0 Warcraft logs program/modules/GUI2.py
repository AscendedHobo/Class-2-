...
# Function to filter and plot location data
def plot_scatter():
    ...
    if filtered_df.empty:
        ...
        plt.scatter(filtered_df["X coord"], filtered_df["Y coord"], alpha=0.6)
...
def plot_heatmap():
    ...
    if filtered_df.empty:
        ...
        plt.figure(figsize=(8, 6))
        sns.kdeplot(x=filtered_df["X coord"], y=filtered_df["Y coord"], cmap="Reds", fill=True)
